          ...
          <Row>
            <Col className="left__content">
              ...
              <Description fontSize="14px" lineHeight="24px">
                Nike Logo Nike is famous for making some of the {'world’s'} most
                coveted sneakers—and for being the envy of sneakerheads
                globally. To tap directly into this community of sneaker lovers,
                Nike tasked us with creating an experience that could connect
                the sneaker community directly with Nike, providing all shoe and
                drop information at users’ fingertips.
              </Description>
            </Col>
            <Col className="img__size">
              <ImgWork src={work04} />
            </Col>
          </Row>
        </Container>
